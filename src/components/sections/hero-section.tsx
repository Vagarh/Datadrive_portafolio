...
const HeroSection = () => {
  return (
    <section id="inicio" className="relative w-full py-24 md:py-32 lg:py-40 bg-background">
      <div className="container px-4 md:px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mt-4 text-xl md:text-2xl text-muted-foreground">
            Científico de Datos & Ingeniero Biomédico
          </p>
          <p className="mt-6 max-w-2xl mx-auto text-lg text-foreground/80">
            Transformando datos en decisiones estratégicas con Python, Cloud y visión por computadora.
          </p>
